...
```{r}
# Here, we combine the independent variables and dependent variables into one data frame. 
...
```{r}
ev_number <- read_excel("data/ev_state.xlsx", skip = 2) %>%
  janitor::clean_names()
